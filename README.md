...
> Alternatively, the password can also be entered in the [user_data](https://github.com/varunrai/fsx-ontap-sqlserver/blob/1d64aeef511004441e50c5db4accd919f9c87e0d/terraform/modules/ec2/ec2-sql.tf#L112) section found in the ec2-sql.tf file (not recommended).
...
This repository is maintained by the contributors listed on [GitHub](https://github.com/varunrai/fsx-ontap-sqlserver/graphs/contributors).
